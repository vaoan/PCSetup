...
- **Console presets**: `console.ffxiv.be` exposes WSL plus the repo quick-connect presets for `Libra`, `Eclipse-con`, `Puck`, `AeleOS`, `Orrery`, and `PCSetup` in persistent and fresh variants.
