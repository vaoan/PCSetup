...
wsl -d $distro --user root -- bash -c "systemctl stop wetty code-server@root ttyd-persistent ttyd-fresh ttyd-proxy dashboard 2>/dev/null; systemctl disable wetty code-server@root ttyd-persistent ttyd-fresh ttyd-proxy dashboard 2>/dev/null; true"
