...
wsl -d $distro --user root -- bash -c "systemctl start code-server@root ttyd-persistent ttyd-fresh ttyd-proxy 2>/dev/null || true" | Out-Null
Write-Log "WSL code-server + ttyd: started"
